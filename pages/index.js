...
export default function Home() {
  return (
    <div>
      ...
      <div className="space-y-32 pt-10 md:pt-20">
        {/* <!--Header--> */}
          ...
          <div className="grid place-self-center">
            ...
            <div className="space-y-6 px-10 md:px-20">
              ...
              <div className="flex space-x-5">
                <input
                  type="text"
                  className="block w-full rounded-md border-gray-300 bg-gray-100 px-7 text-lg focus:border-gray-500 focus:bg-white focus:ring-0"
                  placeholder="Leave us your email"
                />
                <button className="btn hover:text- h-[4.5rem] rounded-md border-none bg-[#008037] px-9 text-lg font-normal capitalize hover:bg-[#037032]">
                  Get Started
                </button>
              </div>
            </div>
        ...
        <div className="bg-at-green grid space-y-20 bg-opacity-10 py-20">
          <div className="grid space-y-5 place-self-center text-center">
            <div className="px-10 text-4xl tracking-tight md:px-0">
              We spice it up different, <br />
              and invite brands like yours to a treat.
            </div>
            <div className="place-self-center px-10 font-medium leading-6 md:w-1/2 md:px-0">
              Win hearts and pockets with data-driven marketing strategies that
              deliver growth at scale for your business.
            </div>
          </div>

          <div className="grid gap-10 px-10 md:grid-cols-3 md:px-20">
            <div className="flex flex-col justify-between space-y-10 rounded-md border bg-white p-10">
              ...
              <div className="flex cursor-pointer items-center space-x-2 hover:opacity-80">
                ...
                <div className="text-sm font-medium text-gray-700">Learn more</div>
              </div>
            </div>
